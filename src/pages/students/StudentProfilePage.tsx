...
export default function StudentProfilePage() {
  ...
  const printCertificate = async (type: 'bonafide' | 'enrollment') => {
    try {
    ...
    <div className="grid gap-4 xl:grid-cols-[330px_1fr]">
      ...
      <div className="space-y-4">
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Metric label="Current status" value={isAttendanceLoading ? 'Loading…' : attendance?.current_status ? attendance.current_status.replace(/^./, (letter: string) => letter.toUpperCase()) : 'Not marked'} detail="Most recently marked attendance" />
